...
router.get('/add', function(req, res, next) {     //adds a posts to site /posts/add
...
router.get('/edit/:id', function(req, res, next) {  // edit post /posts/edit/:id
                     //fetches categories
  var posts = db.get('posts');
  var categories = db.get('categories');
  posts.findOne({_id: req.params.id},function(err,post){  
    ...
    categories.find({},{}, function(err,cats){
      if(err)throw error;
      res.render('editpost', { title: 'Edit Post', categories: cats, post:post});
